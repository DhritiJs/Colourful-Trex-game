...
function preload(){
  ...
  groundImage = loadImage("ground1.jpeg");
...
function setup() {
  ...
  ground = createSprite(width/2,height/2,width,200);
  ground.scale=10;
  ...
  gameOver = createSprite(width/2,height/3+30);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(height-400));
